...
const FITNESS_TABLE: Record<string, Record<string, number>> = {
  ...
  // Content signal task types — derived from coding/review with adjustments
  agentic: {
    // Tool-calling heavy tasks — same as coding with wider spread for top models
    "gpt-5.5": 0.96,
    "gpt-5.4-mini": 0.88,
    "gpt-5.4": 0.94,
    "gemini-3.1-pro": 0.93,
  ...
  reasoning: {
    // Maps to same as analysis — reasoning-optimized task type
    "gpt-5.5": 0.95,
    "claude-opus-4.7": 0.93,
    "claude-opus-4-7": 0.93,
    "gemini-3.1-pro": 0.93,
  ...
  vision: {
    // Vision-capable models boosted, non-vision penalized
    "gpt-5.5": 0.94,
    "gpt-5.4-mini": 0.88,
    "gpt-5.4": 0.92,
    "gemini-3.1-pro": 0.94,
  ...
  complex_coding: {
    // Coding with wider spread — top models boosted, weak penalized
    "gpt-5.5": 0.96,
    "gpt-5.4-mini": 0.88,
    "gpt-5.4": 0.95,
    "gemini-3.1-pro": 0.93,
